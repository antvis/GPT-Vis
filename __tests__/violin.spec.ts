...
test.describe('Violin component tests', () => {
  test('violin', async ({ page }) => {
    const spec = {
      type: 'violin',
      data: violinData,
      axisXTitle: 'Category',
    ...
    await renderChartAndSnapshot(page, spec, 'violin.png');
  });

  test('violin-required', async ({ page }) => {
    const spec = {
      type: 'violin',
      data: violinData,
    };
    await renderChartAndSnapshot(page, spec, 'violin-required.png');
  });

  test('violin-grouped', async ({ page }) => {
    const spec = {
      type: 'violin',
      theme: 'academy',
      data: [
    ...
    await renderChartAndSnapshot(page, spec, 'violin-academy.png');
  });

  test('violin-style', async ({ page }) => {
    const spec = {
      type: 'violin',
      data: violinData,
      axisXTitle: 'Category',
