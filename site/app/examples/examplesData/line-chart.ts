        ...
        config: [
          {
            property: 'type',
            type: 'required',
            description: 'Chart type, required, string type, value must be "line".',
          },
          {
            property: 'data',
            type: 'required',
          ...
          },
          {
            property: 'data.time',
            type: 'required',
            description: 'Time series name, required, string or numeric type.',
          },
          {
            property: 'data.value',
            type: 'required',
          ...
          },
          {
            ...
            type: 'optional',
            description: 'Stroke width, optional, numeric type, value must be greater than 0.',
          },
        ],
      },
    ],
