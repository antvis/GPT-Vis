export const fishboneDiagramData = {
  ...
  galleryJson: {
    ...
    data: {
      name: 'Low Production Efficiency',
      children: [
        { name: 'Equipment Issues', children: [{ name: 'Aging Equipment' }] },
        { name: 'Staff Issues', children: [{ name: 'Insufficient Skills' }] },
        { name: 'Process Issues', children: [{ name: 'Cumbersome Processes' }] },
      ],
    },
  },
  description:
      ...
      json: {
        ...
        data: {
          ...
          children: [
            {
              name: 'Equipment Issues',
              children: [{ name: 'Aging Equipment' }, { name: 'Delayed Maintenance' }],
            },
            {
              name: 'Staff Issues',
              children: [{ name: 'Insufficient Skills' }, { name: 'Poor Work Attitude' }],
            },
            {
              name: 'Process Issues',
              children: [{ name: 'Cumbersome Processes' }, { name: 'Lack of Standardization' }],
            },
          ],
        },
        theme: 'academy',
        ...
        data: {
          ...
          children: [
            ...
            },
            {
              ...
              children: [{ name: 'Unoptimized Database Queries' }, { name: 'Slow API Response' }],
            },
            {
