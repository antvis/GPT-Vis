        ...
        config: [
          {
            property: 'type',
            type: 'required',
            description: 'Chart type, required, string type, value must be "word-cloud".',
          },
          {
            property: 'data',
            type: 'required',
          ...
          },
          {
            property: 'data.text',
            type: 'required',
            description: 'The specific word to display in the word cloud, required, string type.',
          },
          {
            property: 'data.value',
            type: 'required',
            description:
              'The importance score of the word (can be frequency, weight, etc.), required, numeric type.',
          },
          {
            property: 'title',
            type: 'optional',
