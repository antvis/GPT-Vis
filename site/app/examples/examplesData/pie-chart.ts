        ...
        config: [
          {
            property: 'type',
            type: 'required',
            description: 'Chart type, required, string type, value must be "pie".',
          },
          {
            property: 'data',
            type: 'required',
          ...
          },
          {
            ...
            type: 'required',
            description: 'Data category name, required, string type.',
          },
          {
            property: 'data.value',
            type: 'required',
            description: 'Data value, required, numeric type, percentage values cannot be used.',
          },
          {
            property: 'innerRadius',
            type: 'optional',
            description:
              'Set pie chart to donut chart, optional, numeric type, set to 0.6 to enable donut chart.',
          },
          {
            property: 'title',
            type: 'optional',
