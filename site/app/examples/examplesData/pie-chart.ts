  ...
  examples: [
    {
      ...
      json: {
        type: 'pie',
        data: [
          { category: 'Android', value: 71.8 },
          { category: 'iOS', value: 27.2 },
          { category: 'HarmonyOS', value: 0.6 },
          { category: 'Others', value: 0.4 },
        ],
        title: '2024 Global Mobile OS Market Share',
      },
      dsl: 'vis pie\ndata\n  - category Android\n    value 71.8\n  - category iOS\n    value 27.2\n  - category HarmonyOS\n    value 0.6\n  - category Others\n    value 0.4\ntitle "2024 Global Mobile OS Market Share"',
    },
    {
      ...
      json: {
        type: 'pie',
        data: [
          { category: 'Cloud Services', value: 35 },
          { category: 'Cybersecurity', value: 22 },
          { category: 'Software Licenses', value: 20 },
          { category: 'Hardware Maintenance', value: 15 },
          { category: 'Tech Support', value: 8 },
        ],
        innerRadius: 0.6,
    ...
    },
    {
      ...
      json: {
        type: 'pie',
        data: [
          { category: 'Oil', value: 31 },
          { category: 'Natural Gas', value: 24 },
          { category: 'Coal', value: 27 },
          { category: 'Nuclear', value: 4 },
          { category: 'Hydro', value: 7 },
          { category: 'Wind', value: 4 },
          { category: 'Solar', value: 3 },
        ],
        title: 'Global Energy Consumption Structure',
        theme: 'academy',
        style: {
          palette: ['#C45B42', '#7D8C6E', '#D4A373', '#E9C46A', '#A98467', '#8B9A46', '#CB997E'],
