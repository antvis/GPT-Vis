...
export type { AreaConfig, AreaDataItem, AreaOptions } from './vis/area';
export { Bar } from './vis/bar';
export type { BarConfig, BarDataItem, BarOptions } from './vis/bar';
...
export type { ViolinConfig, ViolinDataItem, ViolinOptions } from './vis/violin';
