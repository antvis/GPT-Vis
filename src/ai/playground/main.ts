...
const mindMapBasic = MindMap({
  container: document.getElementById('mindmap-basic')!,
  width: 500,
  height: 400,
});
...
const mindMapAcademy = MindMap({
  container: document.getElementById('mindmap-academy')!,
  width: 500,
  height: 400,
});
...
mindMapAcademy.render({
  data: {
    ...
    children: [
      {
        name: 'Marketing',
        children: [{ name: 'Social Media' }, { name: 'SEO' }],
      },
      {
        name: 'Sales',
        children: [{ name: 'Direct Sales' }, { name: 'Partnerships' }],
      },
    ],
  },
  theme: 'academy',
...
const orgChartBasic = OrganizationChart({
  container: document.getElementById('orgchart-basic')!,
  width: 500,
  height: 400,
});
  ...
  data: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [{ name: 'Accounting Manager', description: 'Accounting' }],
      },
    ],
  },
});
...
const orgChartHorizontal = OrganizationChart({
  container: document.getElementById('orgchart-horizontal')!,
  width: 500,
  height: 400,
});

orgChartHorizontal.render({
  data: {
    name: 'Board',
    children: [
      {
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            name: 'Reports',
            children: [{ name: 'Q1_report.docx' }, { name: 'Q2_report.docx' }],
          },
        ],
      },
      {
...
fishboneBasic.render({
  data: {
    ...
    children: [
      {
        name: '人员',
        children: [{ name: '培训不足' }, { name: '经验缺乏' }, { name: '责任心不强' }],
      },
      {
        name: '方法',
        children: [{ name: '流程不清' }, { name: '标准缺失' }],
      },
      {
        name: '材料',
        children: [{ name: '质量差' }, { name: '供应不稳定' }],
      },
      {
        name: '设备',
        children: [{ name: '老化' }, { name: '维护不当' }],
      },
    ],
  },
});
