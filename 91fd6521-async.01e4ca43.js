(("undefined"!=typeof globalThis?globalThis:self)["makoChunk_@antv/gpt-vis"]=("undefined"!=typeof globalThis?globalThis:self)["makoChunk_@antv/gpt-vis"]||[]).push([["91fd6521"],{"16415a11":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return o;}});var a=n("a2e753d8");n("86ce28a1");var r=n("df67f0d6");let u={code:(0,r.withDefaultChartCode)()},d=[`\u{4E8C}\u{3001}\u{6B8B}\u{4F59}\u{6D41}\u{91CF}\u{5206}\u{6790}\u{548C}\u{5904}\u{7406}
...
\`\`\`
`];var o=()=>(0,a.jsx)(r.GPTVisLite,{components:u,children:d[0]});},"1d926a75":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return o;}});var a=n("a2e753d8");n("79c44ed8");var r=n("df67f0d6");let u={code:(0,r.withChartCode)({languageRenderers:{"my-ui":({children:e})=>(0,a.jsx)("div",{style:{backgroundColor:"#f0f0f0",padding:"10px"},children:e})},components:{[r.ChartType.Pie]:r.Pie}})},d=`
\`\`\`my-ui
my data ...
\`\`\`
...
\`\`\`
`;var o=()=>(0,a.jsx)(r.GPTVisLite,{components:u,children:d});},"37903e7a":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return d;}});var a=n("a2e753d8");n("fc305c7d");var r=n("df67f0d6");let u=`# GPT-VIS 
...
\`\`\`
`;var o=()=>(0,a.jsx)(r.GPTVisLite,{components:u,children:d});},"62fd2610":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"Source",{enumerable:!0,get:function(){return r.default;}});var a=n("d1751d7c"),r=n("777fffbe")._(n("bab36354"));a._(n("27879b75"),t),a._(n("df46a20d"),t),a._(n("2b913cc4"),t),a._(n("83de2887"),t),a._(n("41a1de45"),t),a._(n("4f5b22e1"),t),a._(n("5eb37857"),t);},"9c07645c":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return i;}});var a=n("a2e753d8");n("0247468d");var r=n("df67f0d6"),u=n("9d065c04");let d={code:(0,r.withChartCode)({languageRenderers:{"my-ui":({children:e})=>{let t=(0,r.useEventPublish)();return(0,a.jsxs)("div",{style:{backgroundColor:"#f0f0f0",padding:"10px"},children:[(0,a.jsx)("p",{children:e}),(0,a.jsx)("button",{onClick:()=>{t("xxxclick",{});},type:"button",children:"click"})]});}},components:{}})},o=`
\`\`\`my-ui
my ui data ...
\`\`\`
`;var i=()=>{let[e,t]=(0,u.useState)(0);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsxs)("p",{children:["count: ",e]}),(0,a.jsx)(r.GPTVisLite,{eventSubs:{xxxclick:e=>{console.log("data: ",e),t(e=>e+1);}},components:d,children:o})]});};},b316d85b:function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.e(t,{MyContext:function(){return o;},default:function(){return s;},useMyContext:function(){return i;}});var a=n("852bbaa9"),r=n("a2e753d8");n("b62c491c");var u=n("df67f0d6"),d=a._(n("9d065c04"));let o=d.default.createContext(null);function i(){let e=d.default.useContext(o);if(void 0===e||0===Object.keys(e).length)throw Error("useMyContext must be used within a MyContext.Provider");return e;}let l={code:(0,u.withChartCode)({languageRenderers:{"my-ui":({children:e})=>{let t=i();return console.log("context: ",t),(0,r.jsxs)("div",{style:{backgroundColor:"#f0f0f0",padding:"10px"},children:[(0,r.jsx)("p",{children:e}),(0,r.jsx)("button",{onClick:null==t?void 0:t.onClick,type:"button",children:"click"})]});}},components:{}})},c=`
\`\`\`my-ui
my ui data ...
\`\`\`
`;var s=()=>{let[e,t]=(0,d.useState)(0),n=(0,d.useCallback)(()=>{console.log("handleClick"),t(e=>e+1);},[]),a=(0,d.useMemo)(()=>({count:e,onClick:n}),[e]);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)("p",{children:["count: ",e]}),(0,r.jsx)(o.Provider,{value:a,children:(0,r.jsx)("div",{children:(0,r.jsx)("div",{children:(0,r.jsx)(u.GPTVisLite,{components:l,children:c})})})})]});};},de9f8c55:function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return d;}});var a=n("a2e753d8");n("b1a62842");var r=n("df67f0d6");let u=`# GPT-VIS 
...
\`\`\`
`;var d=()=>(0,a.jsx)(r.GPTVis,{children:u});},df67f0d6:function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.e(t,{ConfigProvider:function(){return o.default;},GPTVis:function(){return i.default;},GPTVisLite:function(){return l.default;},useEventPublish:function(){return l.useEventPublish;},version:function(){return c.default;},withChartCode:function(){return d.withChartCode;},withDefaultChartCode:function(){return d.withDefaultChartCode;}});var a=n("d1751d7c"),r=n("777fffbe"),u=n("852bbaa9");a._(n("5639510f"),t),a._(n("d382b880"),t),a._(n("8e074ce8"),t);var d=n("a574afdb"),o=r._(n("a7265236")),i=r._(n("2c69d5f6")),l=u._(n("033b3748")),c=r._(n("7cf1dc46"));}}]);
//# sourceMappingURL=91fd6521-async.01e4ca43.js.map